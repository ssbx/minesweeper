...
let get_mag ms = Int.to_float ms |> ( *. ) speed
...
let poll_dirs () =
  ...
  | hn, vn -> Int.to_float hn *. diag_vec, Int.to_float vn *. diag_vec
;;

let rec update ms = function
  | ({ transform_cmp = Some trans; keyin_cmp = Some _keyint; _ } : Entity.t) :: tail ->
...
let handle_event = function
  | Sdl.Event.SDL_KEYUP { scancode = W; _ } | Sdl.Event.SDL_KEYUP { scancode = UP; _ } ->
    up_pressed := false
  | Sdl.Event.SDL_KEYUP { scancode = S; _ } | Sdl.Event.SDL_KEYUP { scancode = DOWN; _ }
    -> down_pressed := false
  | Sdl.Event.SDL_KEYUP { scancode = D; _ } | Sdl.Event.SDL_KEYUP { scancode = RIGHT; _ }
    -> right_pressed := false
  | Sdl.Event.SDL_KEYUP { scancode = A; _ } | Sdl.Event.SDL_KEYUP { scancode = LEFT; _ }
    -> left_pressed := false
  | Sdl.Event.SDL_KEYDOWN { scancode = W; _ } | Sdl.Event.SDL_KEYDOWN { scancode = UP; _ }
    -> up_pressed := true
  | Sdl.Event.SDL_KEYDOWN { scancode = S; _ }
  | Sdl.Event.SDL_KEYDOWN { scancode = DOWN; _ } -> down_pressed := true
  | Sdl.Event.SDL_KEYDOWN { scancode = D; _ }
  | Sdl.Event.SDL_KEYDOWN { scancode = RIGHT; _ } -> right_pressed := true
  | Sdl.Event.SDL_KEYDOWN { scancode = A; _ }
  | Sdl.Event.SDL_KEYDOWN { scancode = LEFT; _ } -> left_pressed := true
